...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        // IMPORTANT for highScore feature
        if (!MyVariables.userDefaults.bool(forKey: "HasLaunchedOnce")) {
            MyVariables.userDefaults.set(true, forKey: "HasLaunchedOnce")
            MyVariables.userDefaults.synchronize()
            
//            print("this is my first time launching")
